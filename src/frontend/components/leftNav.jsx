      ...
      <nav className="flex flex-col w-2/6 h-screen items-start pl-14 pr-10 py-10 justify-between">
        <div className="flex flex-col items-start min-w-full text-xl font-medium gap-4">
          <img
            ...
            alt="logo"
            className="w-14 h-14 rounded-full mb-10 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] cursor-pointer"
          />
          <NavLink
            to="/"
            style={navActive}
            className="flex items-center gap-5 cursor-pointer w-full rounded-full"
          >
            <AiFillHome /> Home
          </NavLink>
          <NavLink
          ...
          <button
            className="bg-purple w-fit py-2 px-12 m-auto rounded-full text-white text-lg font-semibold hover:bg-dark-purple transition ease-out delay-100"
            title="post"
          >
            Post
          </button>
        ...
        <div className="flex items-center gap-4 cursor-pointer px-2 py-2 rounded-full hover:bg-purple hover:text-white transition ease-out delay-100 relative">
          ...
          <CgMore
            ...
            title="more"
            onClick={() => setToggleLogoutButton((prev) => !prev)}
          />
          {toggleLogoutButton && (
            <button
              className="absolute bottom-12 left-28 bg-purple text-lg font-semibold text-white py-2 px-12 rounded-full shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] transition-all hover:bg-dark-purple"
